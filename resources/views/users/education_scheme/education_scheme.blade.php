                                    ...
                                    @foreach ($education_scheme as $value)
                                     ...
                                     <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- <a href="{{ url('education_view/'.$value->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"> <i class="fas fa-eye"></i></a> --}}
                                            ...
                                            {{-- <td>  <a href="{{ url('education_scheme_certificate_view') }}" class="btn btn-primary shadow btn-xs sharp me-1"> <i class="fas fa-eye"></i></a></td> --}}
