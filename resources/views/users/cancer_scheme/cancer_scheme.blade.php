                                ...
                                @foreach ($cancer as $row)
                                     ...
                                     <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('cancer_view/'.$row->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"> <i class="fas fa-eye"></i></a>
                                            </td>
                                            <td> <a href="{{ url('cancer_scheme_certificate_view') }}" class="btn btn-primary shadow btn-xs sharp me-1"> <i class="fas fa-eye"></i></a></td>
