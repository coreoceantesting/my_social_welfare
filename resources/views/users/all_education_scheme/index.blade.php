<x-admin.layout>
    ...
    <x-slot name="heading">Education Schemes (शिक्षण योजना)</x-slot>
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="cast_category" id="cast_category">
        ...
        <div class="row" id="viewDetailsContainer" style="display:none;">
            <div class="col">
                <form class="form-horizontal form-bordered" method="post" id="viewDetailsForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body py-2">
                            <input type="hidden" id="view_model_id" name="view_model_id" value="">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="" id="Newview_signature" target="blank">View Document</a>
                                    <span class="text-danger is-invalid candidate_signature_err"></span>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="" id="Newview_photo" target="blank">View Document</a>
                                    <span class="text-danger is-invalid passport_size_photo_err"></span>
                                </div>

                                <div class="row" id="ViewdynamicDocuments">

                                </div>

                            </div>
                            <a id="cancelView" class="btn btn-primary">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    ...
                    $("#viewDetailsForm input[name='view_model_id']").val(data.formDetail.all_education_scheme_detail_id);
                    $("#viewDetailsForm input[name='full_name']").val(data.formDetail.full_name);
                    $("#viewDetailsForm select[name='gender']").val(data.formDetail.gender);
                    $("#viewDetailsForm input[name='dob']").val(data.formDetail.dob);
                    $("#viewDetailsForm select[name='marital_status']").val(data.formDetail.marital_status);
                    $("#viewDetailsForm select[name='cast_category']").val(data.formDetail.cast_category);
                    $("#viewDetailsForm input[name='mobile_no']").val(data.formDetail.mobile_no);
                    $("#viewDetailsForm input[name='aadhar_no']").val(data.formDetail.aadhar_no);
                    $("#viewDetailsForm input[name='father_or_husband_full_name']").val(data.formDetail.father_or_husband_full_name);
                    $("#viewDetailsForm input[name='mother_full_name']").val(data.formDetail.mother_full_name);
                    $("#viewDetailsForm textarea[name='address']").val(data.formDetail.address);
                    $("#viewDetailsForm select[name='occupation']").val(data.formDetail.occupation);
                    $("#viewDetailsForm input[name='annual_income']").val(data.formDetail.annual_income);
                    $("#viewDetailsForm select[name='ward']").val(data.formDetail.ward);
                    $("#viewDetailsForm input[name='years_lived_in_ward']").val(data.formDetail.years_lived_in_ward);
                    $("#viewDetailsForm input[name='educational_qulification']").val(data.formDetail.educational_qulification);
                    $("#viewDetailsForm input[name='scholarship_name']").val(data.formDetail.scholarship_name);
                    $("#viewDetailsForm input[name='marks_obtained']").val(data.formDetail.marks_obtained);
                    $("#viewDetailsForm input[name='scholarship_year']").val(data.formDetail.scholarship_year);
                    $("#viewDetailsForm input[name='type_of_disability']").val(data.formDetail.type_of_disability);
                    $("#viewDetailsForm input[name='disability_certificate_no']").val(data.formDetail.disability_certificate_no);
                    $("#viewDetailsForm textarea[name='hospital_name']").val(data.formDetail.hospital_name);
                    $("#viewDetailsForm input[name='degree_of_disability']").val(data.formDetail.degree_of_disability);
                    $("#viewDetailsForm input[name='bank_name']").val(data.formDetail.bank_name);
                    $("#viewDetailsForm input[name='branch_name']").val(data.formDetail.branch_name);
                    $("#viewDetailsForm input[name='account_holder_name']").val(data.formDetail.account_holder_name);
                    $("#viewDetailsForm input[name='account_no']").val(data.formDetail.account_no);
                    $("#viewDetailsForm input[name='ifsc_code']").val(data.formDetail.ifsc_code);
                    var candidate_signature = 'storage/' + data.formDetail.candidate_signature;
                    var passport_size_photo = 'storage/' + data.formDetail.passport_size_photo;
                    $("#Newview_signature").attr("href", candidate_signature);
                    $("#Newview_photo").attr("href", passport_size_photo);

                    // dynamicDcoument View
                    if (data.documents && data.documents.length > 0) {
                        $("#ViewdynamicDocuments").empty();
                        var documentsHtml = '';
                        ...
                        $("#ViewdynamicDocuments").append(documentsHtml);
                    }
