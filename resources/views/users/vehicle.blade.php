                    ...
                    <form class="theme-form"  name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4 mt-3">
                                    <label class="col-form-label" for="four_wheeler">8. Four Wheeler Training Fee Rs.520 /चारचाकी प्रशिक्षण फि रक्कम रू ५२०/-<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 mt-3">
                                    <label class="col-form-label" for="receipt_no">9. Receipt No. of payment of 10% of training amount. /प्रशिक्षणाची १० टक्के रक्कम भरल्याची पावती क्रमांक.<span class="text-danger">*</span></label>
