            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="row pt-3">
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <p class="mb-0">
                                        <strong>Candidate signature: </strong> <img src="{{ asset('storage/' . $data->candidate_signature) }}" alt="Photo" style="max-width: 100px; height: auto;">
                                    </p>
                    ...
                    <div class="submit-section text-right pt-5" style="float:right;margin-bottom:50px;">
					    <a href="{{ url('dmc_divyang_registration_list/1') }}" class="btn btn-danger btn-lg text-light" >Cancel</a>
