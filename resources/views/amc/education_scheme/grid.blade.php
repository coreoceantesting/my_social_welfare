                                ...
                                <tbody>
                                    @foreach ($data as $value)
                                        <tr>
                                            ...
                                            @endif
                                            <td>  <a href='{{ url("amc_education_scheme_application_view/{$value->id}/{$value->amc_status}") }}' class="btn btn-primary shadow btn-xs sharp me-1"> <i class="fas fa-eye"></i></a></td>
                                        </tr>
                                        @endforeach
                             </tbody>
                            </table>
