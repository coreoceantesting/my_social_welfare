                                ...
                                <tbody>
                                    @foreach ($wards as $ward)
                                        <tr>
                                            ...
                                            <td>{{$ward->name}}</td>
                                            <td>
                                                <button class="edit-element btn btn-primary text-white px-2 py-1" title="Edit ward" data-id="{{ $ward->id }}"><i data-feather="edit"></i></button>
                                                <button class="btn btn-danger text-white rem-element px-2 py-1" title="Delete ward" data-id="{{ $ward->id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
