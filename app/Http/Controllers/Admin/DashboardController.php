...
// Women and Child walfare counting
    ...
    $dmc_senior_bus_concession_scheme_reject = DB::table('trans_bus_concession_scheme AS t1')
        ...
        return view('admin.dashboard', compact('scheme', 'scheme_name', 'bus_concession_scheme_count','disability_scheme_total_count',
        
                                    'education_scheme_total_count','marriage_scheme_total_count','women_education_scheme_total_count',
                                    'women_education_scheme_total_count','sports_scheme_total_count','vehicle_scheme_total_count',
                                    'women_scheme_total_count','women_bus_concession_scheme_count','cancer_scheme_total_count','senior_bus_concession_scheme_count',
                                    'bus_concession_scheme_pending', 'bus_concession_scheme_approve','bus_concession_scheme_reject',
                                     'disability_scheme_pending', 'disability_scheme_approve', 'disability_scheme_reject',
                                    'education_scheme_pending','education_scheme_approve','education_scheme_reject',
                                    'marriage_scheme_pending','marriage_scheme_approve','marriage_scheme_reject',
                                    'women_bus_concession_scheme_pending','women_bus_concession_scheme_approve','women_bus_concession_scheme_reject',
                                    'women_education_scheme_pending', 'women_education_scheme_approve','women_education_scheme_reject',
                                     'sports_scheme_pending','sports_scheme_approve','sports_scheme_reject',
                                     'vehicle_scheme_pending','vehicle_scheme_approve','vehicle_scheme_reject',
                                     'women_scheme_pending', 'women_scheme_approve', 'women_scheme_reject',
                                     'cancer_scheme_pending','cancer_scheme_approve','cancer_scheme_reject',
                                     'senior_bus_concession_scheme_pending','senior_bus_concession_scheme_approve','senior_bus_concession_scheme_reject',
                                     
                                   'ac_bus_concession_scheme_count','ac_bus_concession_scheme_pending','ac_bus_concession_scheme_approve','ac_bus_concession_scheme_reject',
                                     'ac_disability_scheme_total_count','ac_disability_scheme_pending','ac_disability_scheme_approve','ac_disability_scheme_reject',
                                     'ac_education_scheme_total_count','ac_education_scheme_pending','ac_education_scheme_approve','ac_education_scheme_reject',
                                     'ac_marriage_scheme_total_count','ac_marriage_scheme_pending','ac_marriage_scheme_approve','ac_marriage_scheme_reject',
                                     'ac_women_bus_concession_scheme_count','ac_women_bus_concession_scheme_pending','ac_women_bus_concession_scheme_approve',
                                     'ac_women_bus_concession_scheme_reject','ac_women_education_scheme_total_count','ac_women_education_scheme_pending',
                                     'ac_women_education_scheme_approve','ac_women_education_scheme_reject','ac_sports_scheme_total_count',
                                     'ac_sports_scheme_pending','ac_sports_scheme_approve','ac_sports_scheme_reject',
                                     'ac_vehicle_scheme_total_count','ac_vehicle_scheme_pending','ac_vehicle_scheme_approve',
                                     'ac_vehicle_scheme_reject','ac_women_scheme_total_count','ac_women_scheme_pending','ac_women_scheme_approve',
                                     'ac_women_scheme_reject','ac_cancer_scheme_total_count','ac_cancer_scheme_pending','ac_cancer_scheme_approve',
                                     'ac_cancer_scheme_reject','ac_senior_bus_concession_scheme_count','ac_senior_bus_concession_scheme_pending',
                                     'ac_senior_bus_concession_scheme_approve','ac_senior_bus_concession_scheme_reject',
                                     
                                    'amc_bus_concession_scheme_count','amc_bus_concession_scheme_pending','amc_bus_concession_scheme_approve','amc_bus_concession_scheme_reject',
                                    'amc_disability_scheme_total_count','amc_disability_scheme_pending','amc_disability_scheme_approve','amc_disability_scheme_reject',
                                    'amc_education_scheme_total_count','amc_education_scheme_pending','amc_education_scheme_approve','amc_education_scheme_reject',
                                    'amc_marriage_scheme_total_count','amc_marriage_scheme_pending','amc_marriage_scheme_approve','amc_marriage_scheme_reject',
                                    'amc_women_bus_concession_scheme_count','amc_women_bus_concession_scheme_pending','amc_women_bus_concession_scheme_approve',
                                    'amc_women_bus_concession_scheme_reject','amc_women_education_scheme_total_count','amc_women_education_scheme_pending',
                                    'amc_women_education_scheme_approve','amc_women_education_scheme_reject','amc_sports_scheme_total_count',
                                    'amc_sports_scheme_pending','amc_sports_scheme_approve','amc_sports_scheme_reject',
                                    'amc_vehicle_scheme_total_count','amc_vehicle_scheme_pending','amc_vehicle_scheme_approve',
                                    'amc_vehicle_scheme_reject','amc_women_scheme_total_count','amc_women_scheme_pending','amc_women_scheme_approve',
                                    'amc_women_scheme_reject','amc_cancer_scheme_total_count','amc_cancer_scheme_pending','amc_cancer_scheme_approve',
                                    'amc_cancer_scheme_reject','amc_senior_bus_concession_scheme_count','amc_senior_bus_concession_scheme_pending',
                                    'amc_senior_bus_concession_scheme_approve','amc_senior_bus_concession_scheme_reject',
                                    
                                    'dmc_bus_concession_scheme_count','dmc_bus_concession_scheme_pending','dmc_bus_concession_scheme_approve','dmc_bus_concession_scheme_reject',
                                    'dmc_disability_scheme_total_count','dmc_disability_scheme_pending','dmc_disability_scheme_approve','dmc_disability_scheme_reject',
                                    'dmc_education_scheme_total_count','dmc_education_scheme_pending','dmc_education_scheme_approve','dmc_education_scheme_reject',
                                    'dmc_marriage_scheme_total_count','dmc_marriage_scheme_pending','dmc_marriage_scheme_approve','dmc_marriage_scheme_reject',
                                    'dmc_women_bus_concession_scheme_count','dmc_women_bus_concession_scheme_pending','dmc_women_bus_concession_scheme_approve',
                                    'dmc_women_bus_concession_scheme_reject','dmc_women_education_scheme_total_count','dmc_women_education_scheme_pending',
                                    'dmc_women_education_scheme_approve','dmc_women_education_scheme_reject','dmc_sports_scheme_total_count',
                                    'dmc_sports_scheme_pending','dmc_sports_scheme_approve','dmc_sports_scheme_reject',
                                    'dmc_vehicle_scheme_total_count','dmc_vehicle_scheme_pending','dmc_vehicle_scheme_approve',
                                    'dmc_vehicle_scheme_reject','dmc_women_scheme_total_count','dmc_women_scheme_pending','dmc_women_scheme_approve',
                                    'dmc_women_scheme_reject','dmc_cancer_scheme_total_count','dmc_cancer_scheme_pending','dmc_cancer_scheme_approve',
                                    'dmc_cancer_scheme_reject','dmc_senior_bus_concession_scheme_count','dmc_senior_bus_concession_scheme_pending',
                                    'dmc_senior_bus_concession_scheme_approve','dmc_senior_bus_concession_scheme_reject' 
                                 ));
